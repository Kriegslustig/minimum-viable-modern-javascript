...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _markdownParser2.default)(document.getElementById('presentation'));
	...
	_bespoke2.default.from('#presentation', [(0, _bespokeKeys2.default)(), (0, _bespokeThemeCube2.default)()]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _showdown = __webpack_require__(10);
	...
	var convertMarkdown = function convertMarkdown(el) {
	  var html = converter.makeHtml(el.innerHTML);
	  el.innerHTML = html;
	  return html;
	};
	
	module.exports = function (parent) {
	  return Array.from(parent.querySelectorAll('section.markdown')).map(convertMarkdown);
	};
